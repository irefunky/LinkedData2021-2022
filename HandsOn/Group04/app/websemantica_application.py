...
def get_color(point, station):
  q2019 = get_no2_pm10_o3(station, f'2019-12-{target_date}', g)
  q2020 = get_no2_pm10_o3(station, f'2020-12-{target_date}', g)
...
# INIT VALUES
dic = {58:[313,137], 60:[621,217], 57:[725,245], 27:[1021,333], 55:[1017,403], 59:[887,411], 39:[535,329],50:[623,387], 16:[805,509], 11:[667,453], 17:[535, 951], 54:[901,825], 40:[757,755], 36:[781,659], 56:[517,769], 18:[465,725],  47:[629,703], 24:[411,607], 38:[553,478], 48:[617,511], 4:[537,585], 35:[573, 605], 8:[645, 589], 49:[645,627]}
...
while run:
  ### Initialize values
  target_date = input('  Please, now select the day of december you want to now about> ')
  ...
  for region in tqdm(regions):
      ...
      plt.fill(*zip(*polygon), alpha=0.5, color=get_color(dic[d[flag]], d[flag]), linewidth=2)
      flag += 1
